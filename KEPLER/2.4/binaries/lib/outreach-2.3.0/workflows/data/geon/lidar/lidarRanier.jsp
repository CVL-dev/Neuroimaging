...
if (user == null) user = "";
System.out.println("Entered Ranier: " + user + " " + new Date().toString()); 
ExecutionThread _thread = new ExecutionThread();
_thread._logExecution("Entered Rainier: " + user + " " + new Date().toString()+"\n",  "lidarAccess");
%>
<HEAD>
...
<TR>
<TD width="55%">
This page offers access to LiDAR data of the western Rainier seismic zone, adjacent to Mt. Rainier, in Pierce County, WA.  This data set covers approximately 325 square kilometers and includes approximately a billion data points. Point density is approximately 2 points per square meter.  For more information on these data please see this <a href="http://gsa.confex.com/gsa/2003AM/finalprogram/abstract_67004.htm" target="_new">abstract</a>. Select the yellow button at right for the projection and datum of this data set:&nbsp;
...
<TD><div id='projection' style='display:none; padding-top:3;' >
    ...
    <tr><td>Zone: Washington North</td></tr>
...
<TABLE  cellpadding=2 width="30%">
    ...
    <TD colspan="5">
        <script language='Javascript'>
         var demisWMS = "http://geon07.sdsc.edu/wmsconnector/com.esri.wms.Esrimap/lidar_rain"
         function writeMaps(){
	      map = new quickWMS(1298200, -93100, 1438900, 47600,"EPSG:2285");
              map.addLayer(demisWMS, "6,4,3,2,1,0", "1.1.1");
...
<TR>
    <TD>MinX</TD><TD><Input type="text" name="MinX" value=""></TD>
    <TD align=right>MinY</TD><TD><Input type="text" name="MinY" value=""></TD>
</TR>
<TR>
    <TD>MaxX</TD><TD><Input type="text" name="MaxX" value=""></TD>
    <TD align=right>MaxY</TD><TD><Input type="text" name="MaxY" value=""></TD>
</TR>
    <TR>
<!--        <TD colspan=5><HR></TD> -->
        <TD colspan=5><BR></TD>
...
<TD colspan=5><div id='classinf' style='display:none; padding-top:3;' >
    ...
    <TR>
		...
		<INPUT TYPE="hidden" name="srid" value=1007 />
	    <TR>
