...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "/omi/jsp/images/"	// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	function inc100Year() {
		...
		nStartingYear = nStartingYear + 100;
		bShow=true
	}
	...
	function constructYear() {
		...
		if (!yearConstructed) {
			...
			sHTML += "<tr><td align='center' onmouseover='this.style.backgroundColor=\"#FFFFFF\"; this.style.borderColor=\"#666666\"' onmouseout='this.style.backgroundColor=\"\"; this.style.borderColor=\"#FFFFFF\"' style='cursor:pointer; border: 1px solid #ffffff;' bgcolor=#ffffff onmousedown='clearInterval(intervalID2);intervalID2=setInterval(\"inc100Year()\",30);'	onmouseup='clearInterval(intervalID2)'>++</td></tr>"
	...
	function popUpCalendar(ctl, ctl2, format, frameOffSetLeft, frameOffSetTop) {
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				crossobj.left =	fixedX==-1 ? ctl.offsetLeft + leftpos + frameOffSetLeft -140 : fixedX - 90
