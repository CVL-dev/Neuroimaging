...
#define GM_BUILD_CONFIGURE_ARGS "./configure  '--prefix=/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18' '--enable-shared'"

/* CPPFLAGS used for preprocessing */
#define GM_BUILD_CPPFLAGS "-I/usr/include/freetype2"
...
#define GM_BUILD_LDFLAGS "-L/usr/lib"

/* LIBS used for linking */
#define GM_BUILD_LIBS "-lfreetype -ljpeg -lpng12 -lXext -lSM -lICE -lX11 -lz -lm -lgomp -lpthread"
...
#define MagickBinPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/bin/"

/* Location of coder modules */
#define MagickCoderModulesPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/lib/GraphicsMagick-1.3.18/modules-Q8/coders/"
...
#define MagickFilterModulesPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/lib/GraphicsMagick-1.3.18/modules-Q8/filters/"
...
#define MagickLibConfigPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/lib/GraphicsMagick-1.3.18/config/"
...
#define MagickLibPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/lib/GraphicsMagick-1.3.18/"
...
#define MagickShareConfigPath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/share/GraphicsMagick-1.3.18/config/"
...
#define MagickSharePath "/usr/local/src/GRAPHICSMAGICK/1.3.18/graphicsmagick_build/graphicsmagick/1.3.18/share/GraphicsMagick-1.3.18/"
