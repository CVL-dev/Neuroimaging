...
__kits_to_load = [ 'VisualizationVTKWidgets', 'VisualizationVTKCore', 'ScriptingPythonWidgets', 'ScriptingPythonCore', 'ImageProcessingITKCore', 'DICOMWidgets', 'DICOMCore', 'Widgets', 'Core',  ]
